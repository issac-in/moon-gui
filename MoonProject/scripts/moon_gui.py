...
# default image for frame_img & UPPER_CASE because it's a constant.
DEFAULT_IMG = "../moon_images/moon_phases/Invalid Date.png"

# widgets for frame_img
img_moon = ImageTk.PhotoImage(Image.open(DEFAULT_IMG))
